...
if metflag == 0
          ...
          xb = x*bhat;
          rhox = c_sem(rho,y,xb,sige,W,detval,V,a1,a2);
          accept = 0;
          ...
          while accept == 0
           ...
           rhoy = c_sem(rho2,y,xb,sige,W,detval,V,a1,a2);
          ru = unif_rnd(1,0,1);
          if ((rhoy - rhox) > exp(1)),
          p = 1;
          else,          
...
if metflag == 0
          ...
          % update rho using metropolis-hastings
           xb = x*bhat;
           rhox = c_sem(rho,y,xb,sige,W,detval,ones(n,1),a1,a2);
          accept = 0;
          rho2 = rho + cc*randn(1,1);
          while accept == 0
           if ((rho2 > rmin) & (rho2 < rmax)); 
           ...
           rhoy = c_sem(rho2,y,xb,sige,W,detval,ones(n,1),a1,a2);
          ru = unif_rnd(1,0,1);
          if ((rhoy - rhox) > exp(1)),
          p = 1;
          else,          
...
function cout = c_sem(rho,y,xb,sige,W,detval,vi,a1,a2);
