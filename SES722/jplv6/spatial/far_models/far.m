...
[xpxi,flag] = invpd(xpxi);
if flag == 1
fprintf(1,'far: hessian matrix not positive definite \n');
xpxi = abs(xpxi);
end;
...
[xpxi,flag] = invpd(hessn);
if flag == 1
fprintf(1,'far: hessian matrix not positive definite augmenting small eigenvalues \n');
xpxi = abs(xpxi);
end;
