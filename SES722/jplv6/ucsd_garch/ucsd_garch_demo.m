...
% PURPOSE: ucsd garch demo program
clear all;
...
[statistic, siglevel, H]=kolmogorov(x./sqrt(ht),.05,'normcdf');
...
pause;
[parameters, stderrors, robustSE, SEregression, errors, LLF, scores, likelihoods]=armaxfilter(y,1,1,1);
...
fprintf(1,'Press any key to estimate.')
pause;
[parametersAP, likelihoodAP, stderrorsAP, robustSEAP, htAP, scoresAP]=multigarch(errors,1,1,'APGARCH','NORMAL');
...
fprintf(1,'Press any key to estimate.')
pause;
[parametersT, likelihoodT, stderrorsT, robustSET, htT, scoresT]=multigarch(errors,1,1,'APGARCH','STUDENTST');
