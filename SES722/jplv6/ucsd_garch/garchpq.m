function [parameters, likelihood, stderrors, robustSE, ht, scores, grad] = garchpq(data , p , q , startingvals, options)
% PURPOSE: GARCH(P,Q) parameter estimation with normal innovations using analytic derivatives
%
% [parameters, likelihood, stderrors, robustSE, ht, scores, grad] = garchpq(data , p , q , startingvals, options)
%
% Inputs:
...
%  The included MEX is for R12 Windows and was compiled with VC++6. It gives a 10-15 times speed increase
%
...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD, HESSIAN] =  fmincon('garchlikelihood', [omega ; alpha ; beta] ,sumA  , sumB ,[] , [] , LB , UB,[],options,data, p , q);
