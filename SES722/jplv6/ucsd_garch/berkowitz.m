...
% PURPOSE: Performs a Kolmogorov-Smirnov test using the Berkowitz transform to a univariate normal
% that the data are from a specified distribution
% 
% USAGE:  [statistic, pvalue, H]=berkowitz(x,size,type,dist,varargin)
%
% % INPUTS:
